...
const LoadingBonuceDIV = styled.div`
  display: flex;
  ...
  h1.loading-text span:nth-child(2) {
    animation-delay: 0.1s;
  }
  h1.loading-text span:nth-child(3) {
    animation-delay: 0.2s;
  }
  h1.loading-text span:nth-child(4) {
    animation-delay: 0.3s;
  }
  h1.loading-text span:nth-child(5) {
    animation-delay: 0.4s;
  }
  h1.loading-text span:nth-child(6) {
    animation-delay: 0.5s;
  }
  h1.loading-text span:nth-child(7) {
    animation-delay: 0.6s;
  }
  h1.loading-text span:nth-child(8) {
    animation-delay: 0.7s;
  }
  h1.loading-text span:nth-child(9) {
    animation-delay: 0.8s;
  }
  h1.loading-text span:nth-child(10) {
      ...
      <div className="loading-textBox">
        <h1 className="loading-text">
          {loading.map((srt, index) => {
            return <span key={index}>{srt}</span>;
          })}
        </h1>
      </div>
    </LoadingBonuceDIV>
